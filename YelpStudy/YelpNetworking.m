...
static NSString const * kClient_id = @"h2HBtNg5bMO5gossWplqDw";
static NSString const * kClient_secret =
        @"ZY7mvs4MkqzUUCf5DmImAg912PpuMNkyl7d22C5Uxt61sEYFekQ6cudT5c2Muf29";
...
- (void)fetchRestaurantsBasedOnLocation:(CLLocation *)location
    term:(NSString *)term completionBlock:
   (RestaurantCompletionBlock)completionBlock;
{
